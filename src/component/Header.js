    ...
    <div className="headerComponent">
      ...
      <div className="mobileMenu">
        ...
        <ul className="mobileMenuConatiner">
          <li tabindex="0" className="menuHover mobileMenuItem">home</li>
          <li tabindex="0" className="menuHover mobileMenuItem">shop</li>
          <li tabindex="0" className="menuHover mobileMenuItem">about</li>
          <li tabindex="0" className="menuHover mobileMenuItem">contact</li>
        </ul>
      </div>
      ...
      <div className="desktopHeaderContainer">
        ...
        <ul className="desktopMenuContainer">
          <li tabindex="0" className="menuHover menuItem menuHome">home</li>
          <li tabindex="0" className="menuHover menuItem menuShop">shop</li>
          <li tabindex="0" className="menuHover menuItem menuAbout">about</li>
          <li tabindex="0" className="menuHover menuItem menuContact">contact</li>
        </ul>
      </div>
    </div>
  )
