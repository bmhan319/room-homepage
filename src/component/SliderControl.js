...
export default function SliderControl(props) {
  return (
    <div className="sliderControlComponent">
      <div tabindex="0" className="sliderButton sliderLeft" onClick={()=>{props.slider(100)}}  onKeyPress={()=>{props.slider(100)}}>
      ...
      <div tabindex="0" className="sliderButton sliderRight" onClick={()=>{props.slider(-100)}} onKeyPress={()=>{props.slider(-100)}} >
